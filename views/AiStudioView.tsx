...
export const AiStudioView: React.FC<AiStudioViewProps> = ({
  ...
  aiPrompt, // props는 호환성을 위해 남겨두지만 화면에는 표시하지 않습니다.
  setAiPrompt,
  generatedImage,
  isGenerating,
  useMyPhoto,
  ...
  const handleDownload = () => {
    ...
    link.download = `ai-studio-generated-${Date.now()}.png`;
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <div className="max-w-md mx-auto space-y-6">
            ...
            {generatedImage ? (
              <>
                ...
                <button
                  ...
                  className="absolute top-3 right-3 w-10 h-10 bg-black/50 rounded-full text-white flex items-center justify-center hover:bg-black transition-colors"
                  title="이미지 저장"
                >
          ...
          <div className="space-y-3">
            {/* [수정] 요청사항 입력창과 라벨을 삭제했습니다.
               버튼만 남겨두어 원클릭으로 실행되게 합니다.
            */}
